	...
	editGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				$.jgrid.viewModal("#"+$.jgrid.jqID(IDs.themodal),{gbox:"#gbox_"+$.jgrid.jqID(gID),jqm:p.jqModal, jqM: false, overlay: p.overlay, modal:p.modal, focusSelector:rp_ge.focusSelector});
				//shuki end
				if(!closeovrl) {
						...
						if (!$(this).hasClass('ui-state-disabled')) {
							...
							if (sr) {
								if($.isFunction( o.editfunc ) ) {
									//o.editfunc.call($t, sr); shuki 24/10/2012 pass the edit options
