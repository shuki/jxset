 ...
 */
	$.extend($.fn.fmatter , {
		...
		editRowFmatter: function(cellvalue, options, rowdata, act){
			...
			return '<a class="fm-button ui-state-default ui-corner-all fm-button-icon-left" href="javascript:$.jset.fn.edit_row(\'' +  grid_id + '\', ' + cellvalue + ');">' + $.jset.captions.edit + '<span class="ui-icon ui-icon-pencil"></span></a>';
		},		
		deleteRowFmatter: function(cellvalue, options, rowdata, act){
			var grid = $(this);
			var grid_id = 'table#' + grid.attr('id') + '.jset_table';
			return '<a class="fm-button ui-state-default ui-corner-all fm-button-icon-left" href="javascript:$.jset.fn.delete_row(\'' +  grid_id + '\', ' + cellvalue + ');">' + $.jset.captions.delete + '<span class="ui-icon ui-icon-trash"></span></a>';
		},
